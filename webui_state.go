...
Changes:
  1.4.0 - [SECURITY/FIX] Upgraded `SaveGroupOverrides` to proactively monitor 
  ...
  1.3.0 - [SECURITY/FIX] Enforced strict lowercase normalization on group name keys 
  ...
  1.2.0 - [LOGGING] Wired Web UI state transition logs securely into the 
