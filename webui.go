...
Changes:
  ...
  1.57.0 - [LOGGING] Re-routed UI and Server listener startup declarations 
           explicitly over to the `logWebUI` configuration flag organically.
  1.56.0 - [FEAT] Registered `/api/groups` JSON endpoint natively to route 
           rendered HTML snippets securely to the new Web UI Group Refresh engine.
*/
