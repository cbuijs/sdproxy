...
Changes:
  ...
  2.21.0 - [PERF] Injected active `sk` and `clientGroup` parameters natively 
           into `checkTargetNames` and `filterResponseIPs`. Absolutely eliminates 
           redundant group evaluations inside `CheckParental`, massively 
           bolstering multi-level DPI efficiency organically.
*/
