...
func checkTargetNames(w dns.ResponseWriter, r *dns.Msg, resp *dns.Msg, sk, clientGroup, clientMAC, clientIP string, clientAddr netip.Addr, clientName, clientNameLower, clientID, protocol, sni, sniLower, path, pathLower string, bypassPolicies bool, originalQName string) bool {
...
func filterResponseIPs(w dns.ResponseWriter, r *dns.Msg, resp *dns.Msg, sk, clientGroup, clientMAC, clientIP string, clientAddr netip.Addr, clientName, clientNameLower, clientID, protocol, sni, sniLower, path, pathLower string, bypassPolicies bool, originalQName, originalQNameTrimmed string) bool {
