...
Changes:
  1.25.0 - [UI] Removed CPU and Memory polling fields from the background
           refresh routines natively.
  1.24.0 - [UI] Migrated fields bindings to construct compound telemetry values 
           for unified `Queries` and `Cache Performance` panels seamlessly.
*/
