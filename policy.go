...
File:    policy.go
Version: 1.17.0
Updated: 10-Jun-2026 10:35 CEST
...
Changes:
  ...
  1.14.0 - [REFACTOR] Eradicated redundant SOA synthesis and EDNS0 extraction blocks. 
           Injected zero-allocation `SetNegativeSOA` and `PreserveEDNS0` helpers 
           natively from `process_helpers.go` to ensure unified RFC compliance.
